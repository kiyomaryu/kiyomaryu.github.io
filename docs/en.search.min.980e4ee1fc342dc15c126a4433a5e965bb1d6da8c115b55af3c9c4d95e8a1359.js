...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fa36e324a0e5d0afc0130e940a7bab346aaa53bfaa20a68f746242a6c2532c96.js',function(){input.required=false;search();});}
