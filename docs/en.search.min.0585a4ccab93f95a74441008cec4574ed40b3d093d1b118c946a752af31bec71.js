...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.523db21111f55d48b1d25abea3fef46396159ec2b46f075da9eff93347573852.js',function(){input.required=false;search();});}
