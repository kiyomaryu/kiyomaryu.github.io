...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.12edbaf5cc86949a05f86d5376eccd28db90432294532b0a88c91e584b7002ce.js',function(){input.required=false;search();});}
