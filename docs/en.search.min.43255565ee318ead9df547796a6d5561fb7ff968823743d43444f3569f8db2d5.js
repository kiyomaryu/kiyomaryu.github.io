...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.971664d6d995e7e88fc57cfa76eba02b83377372b58ec5393d1517533a2035e9.js',function(){input.required=false;search();});}
